...
def editor_node(state: States) -> dict:
    """Stage 1: Cleans up grammar, removes typos, and refines the tone."""

    print("Editing is in process.....\n")
...
def script_node(state: States) -> dict:
...
def translator_node(state: States) -> dict:
...
result = app.invoke( {"raw_input" :input("Ask about anything: ")})
